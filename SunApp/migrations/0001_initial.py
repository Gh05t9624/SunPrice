# Generated by Django 5.0.7 on 2024-09-04 12:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rôle', models.CharField(choices=[('admin', 'Admin'), ('acheteur', 'Achéteur'), ('particulier', 'Particulier'), ('boutiques', 'Boutiques'), ('supermarket', 'Surper-Marché'), ('superette', 'Superette'), ('station', 'Station-Service')], default='acheteur', max_length=255)),
                ('genre', models.CharField(choices=[('homme', 'Homme'), ('femme', 'Femme')], default='homme', max_length=255)),
                ('situation_matrimoniale', models.CharField(choices=[('celibataire', 'Célibataire'), ('marie', 'Marié(e)')], default='celibataire', max_length=20)),
